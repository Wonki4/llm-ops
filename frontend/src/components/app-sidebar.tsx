...
import { Users, Globe, ShieldCheck, Boxes, LayoutDashboard, LogOut, Calendar, BarChart3, Key, DollarSign, Settings, Inbox, UserCog, Megaphone, Server } from "lucide-react";
...
const navigation: { name: string; href: string; icon: typeof Users; roles: UserRole[] }[] = [
  ...
  { name: "모델 배포", href: "/admin/model-deployments", icon: Server, roles: ["super_user"] },
